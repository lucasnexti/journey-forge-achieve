...
const LeaderboardPage = () => {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      // Get enrollments for all colleagues
      ...
      <div className="bg-gradient-nexti">
        <div className="container py-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display text-3xl font-extrabold text-primary-foreground">Ranking</h1>
              <p className="text-primary-foreground/80">{empresa || "Sua Empresa"}</p>
            </div>
          </div>
        </div>
      </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="tabular-nums text-lg font-bold text-foreground">{entry.completed}</p>
